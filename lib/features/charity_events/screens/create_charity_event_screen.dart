        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: feastLightBlue.withAlpha(100), width: 1.5),
            ),
            child: Center(
              child: Icon(
                Icons.image_outlined,
                size: 56,
                color: feastBlue.withAlpha(120),
              ),
            ),
          ),
              ...
              ...List.generate(
                ...
                (i) => Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: feastLightBlue.withAlpha(80),
                      width: 1,
                    ),
                  ),
                  child: Icon(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // Charity Event Description
          _buildDescriptionField(),
          const SizedBox(height: 16),

          // Call Time of Charity
          LabeledTextField(
            config: LabeledTextFieldConfig(
                ...
                ? () {
                    showDialog(
                      ...
                      builder: (_) => ConfirmationModal(
                        ...
                        body:
                            'Are you sure you want to proceed with posting the charity event?',
                        boldNote:
